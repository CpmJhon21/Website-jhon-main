...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO MY CPM_JHON') // boleh diubah
}
...
var creator = 'Cpm_jhonOfc' // ubah jadi nama lu
const listkey = ["Alphabot","Zeeone","wvAkrvLrjEl4ppH"]; // ubah apikey nya, tambah aja klo mau
